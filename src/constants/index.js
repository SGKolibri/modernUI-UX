...
export const feedback = [
  {
    id: "feedback-1",
    content:
      "O dinheiro é apenas uma ferramenta. Ele te levará aonde você quiser, mas não te substituirá como motorista.",
    name: "Jane Doe",
  ...
  },
  {
    id: "feedback-2",
    content:
      "O dinheiro torna sua vida mais fácil. Se você tem sorte de tê-lo, você é sortudo.",
    name: "John Doe",
    title: "Fundador & Líder",
    img: people02,
  },
  {
    id: "feedback-3",
    content:
      "Geralmente são as pessoas no negócio do dinheiro, finanças e comércio internacional que são realmente ricas.",
    name: "Felipe Smith",
    title: "Fundador & Líder",
    img: people03,
  },
